...
Shown in \Cref{fig:third_d2o_obs,fig:third_salt_obs,fig:third_ncd_pmt_obs} are the observable distributions for a 3 phase fit to the 1/3 dataset as described in \Cref{third}.

\begin{figure}
\centering
\includegraphics[width=0.98\columnwidth]{third_d2o_day}
\includegraphics[width=0.98\columnwidth]{third_d2o_night}
\caption{\label{fig:third_d2o_obs}Observable distributions for D$_2$O phase 1/3 dataset fit.}
\end{figure}
\begin{figure}
\centering
\includegraphics[width=0.98\columnwidth]{third_salt_day}
\includegraphics[width=0.98\columnwidth]{third_salt_night}
\caption{\label{fig:third_salt_obs}Observable distributions for Salt phase 1/3 dataset fit.}
\end{figure}
\begin{figure}
\centering
\includegraphics[width=0.98\columnwidth]{third_ncd_pmt_day}
\includegraphics[width=0.98\columnwidth]{third_ncd_pmt_night}
...
\begin{figure}
\centering
\includegraphics[width=0.98\columnwidth]{third_inf_d2o_day}
\includegraphics[width=0.98\columnwidth]{third_inf_d2o_night}
\caption{\label{fig:third_inf_d2o_obs}Observable distributions for D$_2$O phase 1/3 dataset fit with $k_2$ fixed to infinity.}
\end{figure}
\begin{figure}
\centering
\includegraphics[width=0.98\columnwidth]{third_inf_salt_day}
\includegraphics[width=0.98\columnwidth]{third_inf_salt_night}
\caption{\label{fig:third_inf_salt_obs}Observable distributions for Salt phase 1/3 dataset fit with $k_2$ fixed to infinity.}
\end{figure}
\begin{figure}
\centering
\includegraphics[width=0.98\columnwidth]{third_inf_ncd_pmt_day}
\includegraphics[width=0.98\columnwidth]{third_inf_ncd_pmt_night}
...
\begin{figure}
\centering
\includegraphics[width=0.98\columnwidth]{final_min_d2o_day}
\includegraphics[width=0.98\columnwidth]{final_min_d2o_night}
\caption{\label{fig:final_d2o_obs}Observable distributions for D$_2$O phase final fit.}
\end{figure}
\begin{figure}
\centering
\includegraphics[width=0.98\columnwidth]{final_min_salt_day}
\includegraphics[width=0.98\columnwidth]{final_min_salt_night}
\caption{\label{fig:final_salt_obs}Observable distributions for Salt phase final fit.}
\end{figure}
\begin{figure}
\centering
\includegraphics[width=0.98\columnwidth]{final_min_ncd_pmt_day}
\includegraphics[width=0.98\columnwidth]{final_min_ncd_pmt_night}
...
\begin{figure}
\centering
\includegraphics[width=0.98\columnwidth]{final_inf_d2o_day}
\includegraphics[width=0.98\columnwidth]{final_inf_d2o_night}
\caption{\label{fig:final_inf_d2o_obs}Observable distributions for D$_2$O phase final fit with $k_2$ fixed to infinity.}
\end{figure}
\begin{figure}
\centering
\includegraphics[width=0.98\columnwidth]{final_inf_salt_day}
\includegraphics[width=0.98\columnwidth]{final_inf_salt_night}
\caption{\label{fig:final_inf_salt_obs}Observable distributions for Salt phase final fit with $k_2$ fixed to infinity.}
\end{figure}
\begin{figure}
\centering
\includegraphics[width=0.98\columnwidth]{final_inf_ncd_pmt_day}
\includegraphics[width=0.98\columnwidth]{final_inf_ncd_pmt_night}
