...
This analysis aims to perform such a dedicated fit, specifically for the neutrino mass state 2 lifetime observed as an energy dependent modification to the standard MSW survival probability.
...
The fit will minimize the negative SNO Enhanced Log Likelihood function~\cite{3phase} using this model for the survival probability.
...
This was used to produce previous SNO results which paramaterized the survival probabilites as Nth order polynomials.
This package already implemented the SNO Enhanced Log Likelihood Function, and could be modified to use the model described in \Cref{lifetime_model} instead of polynomials.
...
%Going to need to copy this from P-L?
