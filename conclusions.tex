...
The Cherenkov optical calibration source described in \Cref{ch:chsrc} uses tagged decays of \L to generate Cherenkov light in acrylic, which is independent of the properties of the target material it is deployed in.
...
Scintillation light production is also uncorrelated with the direction of the energetic particle, unlike Cherenkov light.
...
This directional correlation was successfully used to extract the solar neutrino flux from {\snop} water phase, as presented in in \Cref{ch:es}.
