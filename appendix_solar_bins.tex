\chapter{SNO+ $^8$B ES Supplementary Plots}
\label{chap:solar_bins}

\Cref{fig:56,fig:67,fig:78,fig:89,fig:910,fig:1015} show the fit result from each energy bin considered in the SNO+ $^8$B ES analysis overlayed with the data in that bin.
