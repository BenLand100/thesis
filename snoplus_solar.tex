...
As the solar MC is simulated as a uniform distribution inside the AV, and the position resolution of {\snop} is small (O(10cm)), smearing the reconstructed position by this resolution has a 
