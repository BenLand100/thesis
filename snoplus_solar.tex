\chapter{Elastic Scatter of $^8$B Solar Neutrinos in {\snop}}
\label{ch:es}
...
As the solar MC is simulated as a uniform distribution inside the AV, and the position resolution of {\snop} is small (O(10~cm)), smearing the reconstructed position by this resolution has a 
